...
if [[ "$CONFIGURATION" == "Ad Hoc" ]]; then
  install_xcframework "${PODS_ROOT}/Sodium/Clibsodium.xcframework" "" "false" "ios-arm64_x86_64-maccatalyst/libsodium.a" "ios-i386_x86_64-simulator/libsodium.a" "ios-arm64_armv7_armv7s/libsodium.a"
fi
